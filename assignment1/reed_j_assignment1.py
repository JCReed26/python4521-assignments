...
import sys
import random
from testruns import strategy_testSample
...
def testrun(num_of_iterations, num_of_strategies):
    """to import into other python files for testing"""
    main(num_of_iterations, num_of_strategies)

def main(num_of_iterations, num_of_strategies):
    """To separate from name run to allow for testing"""
